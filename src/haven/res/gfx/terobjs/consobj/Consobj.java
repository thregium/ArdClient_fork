...
/* >spr: Consobj */
public class Consobj extends Sprite implements Gob.Overlay.CUpd {
    ...
    public Consobj(Owner owner, Resource res, Message sdt) {
        ...
        if (bmat == null)
            bmat = Resource.remote().loadwait("gfx/terobjs/consobj").layer(Material.Res.class).get();
    ...
    Rendered mkbound(Obstacle obst) {
