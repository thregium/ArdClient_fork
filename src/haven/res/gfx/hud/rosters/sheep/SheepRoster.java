...
public class SheepRoster extends CattleRoster<Sheep> {
    public static List<Column> cols = initcols(
            ...
            new Column<>(Resource.local().load("gfx/hud/rosters/lactate"), Comparator.comparing((Sheep e) -> e.lactate).reversed(), 20).runon(),
            new Column<>(Resource.local().load("gfx/hud/rosters/owned"), Comparator.comparing((Sheep e) -> ((e.owned ? 1 : 0) | (e.mine ? 2 : 0))).reversed(), 20),
