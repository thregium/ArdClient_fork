...
public class RealmChannel extends ChatUI.MultiChat {
    ...
    public class Sender {
        ...
        double lastseen = Utils.ntime(), muted = 0;
    ...
    public void uimsg(String msg, Object... args) {
        if (msg == "msg") {
            ...
            if (cfrom == null) {
                ...
                append(my);
                ChatUI.save(name, my.text().text, super.getparent(GameUI.class).buddies.getCharName());
            } else {
                ...
                if (now > from.muted) {
                    ...
                    if (urgency > 0)
                        notify(cmsg, urgency);
                    ChatUI.save(name, cmsg.text().text);
                }
            }
        } else if (msg == "err") {
    ...
    private static final Indir<Resource> icon = Resource.remote().load("gfx/hud/chat/rlm-p", 1);
